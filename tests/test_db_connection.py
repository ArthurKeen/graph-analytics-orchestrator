...
from graph_analytics_orchestrator.db_connection import get_db_connection, get_connection_info
...
class TestGetDBConnection:
    ...
    def test_password_masked_in_error(self, mock_get_config, mock_env_amp):
        ...
        with patch('graph_analytics_orchestrator.db_connection.ArangoClient') as mock_client_class:
            mock_client = MagicMock()
            mock_sys_db = MagicMock()
