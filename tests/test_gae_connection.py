...
class TestGetGAEConnection:
    ...
    def test_get_connection_amp(self, mock_get_config, mock_env_amp):
        ...
        with patch(
            "graph_analytics_orchestrator.gae_connection.GAEManager"
        ) as mock_manager:
    ...
    def test_get_connection_self_managed(
        ...
        with patch(
            "graph_analytics_orchestrator.gae_connection.GenAIGAEConnection"
        ) as mock_connection:
            connection = get_gae_connection()
...
class TestGenAIGAEConnectionNewMethods:
    ...
    def test_list_services(self, mock_get_config, mock_env_self_managed):
        ...
        with patch(
            "graph_analytics_orchestrator.gae_connection.requests.post"
        ) as mock_post:
            mock_response = MagicMock()
